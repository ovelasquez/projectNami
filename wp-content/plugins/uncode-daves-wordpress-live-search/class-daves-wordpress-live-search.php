...
STYLE;
	...
	public static function admin_menu() {
		...
		add_submenu_page( 'uncode-menu', 'UNCODE', esc_html__( 'Live Search', 'daves-wordpress-live-search' ), 'manage_options', __FILE__, array(
	...
	private static function plugin_options_design() {
		...
		if ( array_key_exists( 'daves-wordpress-live-search_submit', $_POST ) && current_user_can( 'manage_options' ) ) {
			...
			$displayPostCategory = ( 'true' === $_POST['daves-wordpress-live-search_display_post_category'] );
