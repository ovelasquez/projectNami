            ...
            switch ($key) {
                ...
                case 'meta':
                    ...
                    foreach ($block_data['single_categories'] as $cat_key => $cat) {
                        if (isset($cat['tax']) && $cat['tax'] === 'category')
                            $only_cat_counter++;
                    }
                        ...
                        if (isset($block_data['single_categories'][$t_key])) {
                            ...
                            if (gettype($single_cat) !== 'string' && isset($single_cat['link'])) {
                                ...
                                if ($block_data['single_categories'][$t_key]['tax'] === 'category' && !$cat_icon) {
                                    $category .= '<i class="fa fa-stethoscope fa-push-right"></i>';
                                    $cat_icon = true;
                                }
                                ...
                                if (isset($block_data['single_tags']) && $key === 'category' && in_array($cat_link, $block_data['single_tags']))
                                    continue;
                            }
            ...
            if (array_key_exists('media', $layout)) :
                ...
                if ($style_preset === 'metro'):
                    ...
                    if ($media_type === 'image') :
                        ...
                        $output .= $icoTs . '<img' . ($adaptive_async_class !== '' ? ' class="' . trim($adaptive_async_class) . '"' : '') . ' src="' . $item_media . '" width="' . $image_orig_w . '" height="' . $image_orig_h . '" alt="' . $media_alt . '"' . ($adaptive_async_data !== '' ? $adaptive_async_data : '') . ' />';
